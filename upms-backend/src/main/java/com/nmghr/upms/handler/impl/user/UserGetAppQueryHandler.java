 ...
 * @version 1.0
 */
@Service("usergetappQueryHandler")
@SuppressWarnings("all")
public class UserGetAppQueryHandler extends AbstractQueryHandler {
  ...
  public UserGetAppQueryHandler(IBaseService baseService) {
    super(baseService);
  }
  ...
  public Object list(Map<String, Object> requestMap) throws Exception {
    ...
    if (userId.equals("1")) {
      ...
      LocalThreadStorage.put(Constant.CONTROLLER_ALIAS, "USERGETAPPLIST");// 用户获取应用信息
    }
